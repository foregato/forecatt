...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-8 right-8 z-40 hidden h-14 w-14 items-center justify-center md:flex"
    >
      <span className="absolute inset-0 rounded-full bg-accent/40 md:animate-pulse-ring" aria-hidden="true" />
      <span className="relative flex h-14 w-14 items-center justify-center rounded-full bg-ink text-white shadow-lg shadow-ink/20 transition-transform duration-200 hover:scale-105">
        <svg
          viewBox="0 0 24 24"
          width="26"
          height="26"
